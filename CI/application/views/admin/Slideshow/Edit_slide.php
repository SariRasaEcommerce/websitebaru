                ...
                <div class="col-md-12">
                        <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">Form Edit Data Slideshow</div>
                                        </div>
                                        <div class="card-body">
                                            <form method="post" action="<?php echo base_url(). 'index.php/admin/Slideshow/editaction'; ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="pillInput">ID Slideshow</label>
                                                <input type="text" class="form-control input-pill" id="pillInput" placeholder="Masukkan ID Barang" name="id" value="<?php echo $ID_SLIDE; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="pillInput">ID Admin</label>
                                                <input type="text" class="form-control input-pill" id="pillInput" placeholder="Masukkan ID Admin" name="adminn" value="<?php echo $ID_ADMIN; ?>">
                                            </div>
                                            <div class="form-group">
