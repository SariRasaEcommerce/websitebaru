            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form method="post" action="<?php echo base_url(). 'index.php/admin/Data_barang/create'; ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="card-action">
                                            ...
                                            <a href="<?php echo base_url() ?>index.php/admin/Data_barang"><button class="btn btn-danger">Cancel</button></a>
                                        </div>
